...
echo "  Gated datasets require accepting terms on the HuggingFace website"
echo "  BEFORE running the eval (one-time, free):"
echo ""
echo "    GigaSpeech:  https://huggingface.co/datasets/speechcolab/gigaspeech"
echo "    SPGISpeech:  https://huggingface.co/datasets/kensho/spgispeech"
echo ""
echo "  Note: Mozilla Common Voice is no longer on HuggingFace (moved to"
echo "  Mozilla Data Collective in Oct 2025). Accent test 1.6 will be skipped."
echo ""
hf auth login
